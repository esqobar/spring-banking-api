package com.collins.bank.services;
...
public class BankStatement {
    ...
    private static final String FILE = "C:\\Users\\Yvette\\Documents\\MyStatement.pdf";

    /**
     * retrieving list of transactions within a date range given an account number
    ...
    public List<Transaction> generateStatement(String accountNumber, String startDate, String endDate) throws FileNotFoundException, DocumentException  {
        ...
        String customerName = user.getFirstName() + " " + user.getMiddleName() + " " + user.getSurname();
        ...
        PdfPCell bankName = new PdfPCell(new Phrase("Just Java Bank"));
        bankName.setBorder(0);
        bankName.setBackgroundColor(BaseColor.GREEN);
        bankName.setPadding(20f);

        PdfPCell bankAddress = new PdfPCell(new Phrase("72, Come Address, Nairobi Kenya"));
        ...
        EmailDetails emailDetails = EmailDetails.builder()
                ...
                .attachment(FILE)
                .build();
        emailService.sendEmailWithAttachmentAlert(emailDetails);
